...
function Paddle:init(skin, health, score)
...
function Paddle:update(dt, health, score)
    -- keyboard input
    ...
    if health == 3 and score < 2000 then
        self.width = 64
        self.small = false
        self.medium = true
        self.large = false
    elseif health == 3 and score > 2000 then
        self.width = 96
        self.small = false
        self.medium = false
        self.large = true
